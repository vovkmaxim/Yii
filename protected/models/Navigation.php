...
class Navigation extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, title, url, parent, position', 'safe'),
		);
	}
    ...
    public static function menuItems($rootId = 0)
    {
        return self::model()->findAllByAttributes(array('parent' => $rootId), array('order' => 'position'));
    }
}
