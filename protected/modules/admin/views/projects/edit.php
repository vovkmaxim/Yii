            ...
            <div class="control-group">
                <div class="title">
                    ...
                    <?php if (isset($avatar)) : ?>
                        ...
                        ?>
                        <input type="hidden" name="posted_avatar" value="<?php echo base64_encode($fileName); ?>" />
                        </div>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <?php if (!empty($pics)) : ?>
                    <div class="previews">
                        <?php foreach ($pics as $pic) : ?>
                            <div class="preview"><img src="<?php echo Yii::app()->getBaseUrl(true) . $pic->url; ?>"/><a
            ...
            <?php if (isset($previews)) : ?>
                <div class="previews">
                    <?php foreach ($previews as $preview) : ?>
                        <?php if ($preview['title'] == 1) continue; ?>
                        <div class="preview">
                            <input type="hidden" name="previews[]" value="<?php echo md5($preview['filename']); ?>">
                            <img src="<?php echo $preview['url']; ?>"/><a
                                id="<?php echo base64_encode($preview['filename']); ?>"
                                class="delete delete-preview icon-remove"
                                href="#" title="Удалить"> </a><input type="hidden" name="loaded_previews[]"
                                                                     value="<?php echo md5($preview['filename']); ?>">
                        </div>
                    <?php endforeach; ?>
                </div>
            <?php endif; ?>
