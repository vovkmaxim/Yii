...
<!--        --><?php //echo $form->textField($modelContactus,'name',array('size'=>60,'maxlength'=>255)); ?>
<!--        --><?php //echo $form->error($modelContactus,'name'); ?>
<!--    </div>-->
<!---->
<!--    <div class="row">-->
<!--        --><?php //echo $form->labelEx($modelContactus,'email'); ?>
<!--        --><?php //echo $form->textField($modelContactus,'email',array('size'=>60,'maxlength'=>255)); ?>
<!--        --><?php //echo $form->error($modelContactus,'email'); ?>
<!--    </div>-->
<!---->
<!--    <div class="row">-->
<!--        --><?php //echo $form->labelEx($modelContactus,'subject'); ?>
<!--        --><?php //echo $form->textField($modelContactus,'subject',array('size'=>60,'maxlength'=>255)); ?>
<!--        --><?php //echo $form->error($modelContactus,'subject'); ?>
<!--    </div>-->
<!---->
<!--    <div class="row">-->
<!--        --><?php //echo $form->labelEx($modelContactus,'body'); ?>
<!--        --><?php //echo $form->textArea($modelContactus,'body',array('rows'=>6, 'cols'=>50)); ?>
