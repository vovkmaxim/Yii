...
(function (e) {
    ...
    var g = {zindex: "auto", cursoropacitymin: 0, cursoropacitymax: 1, cursorcolor: "#424242", cursorwidth: "5px", cursorborder: "1px solid #fff", cursorborderradius: "5px", scrollspeed: 60, mousescrollstep: 8 * 3, touchbehavior: false, hwacceleration: true, usetransition: true, boxzoom: false, dblclickzoom: true, gesturezoom: true, grabcursorenabled: true, autohidemode: true, background: "", iframeautoresize: true, cursorminheight: 32, preservenativescrolling: true, railoffset: false, bouncescroll: true, spacebarenabled: true, railpadding: {top: 0, right: 0, left: 0, bottom: 0}, disableoutline: true, horizrailenabled: true, railalign: "right", railvalign: "bottom", enabletranslate3d: true, enablemousewheel: true, enablekeyboard: true, smoothscroll: true, sensitiverail: true, enablemouselockapi: true, cursorfixedheight: false, directionlockdeadzone: 6, hidecursordelay: 400, nativeparentscrolling: true, enablescrollonselection: true, overflowx: true, overflowy: true, cursordragspeed: .3, rtlmode: false, cursordragontouch: false, oneaxismousemode: "auto"};
    var y = false;
    var b = function () {
        function o() {
    ...
    var w = function (e, r) {
        ...
        function x(e, t, n) {
            ...
            if (r) {
                if (r < 0) {
                    if (a.getScrollLeft() >= a.page.maxw)return true
                } else {
                    if (a.getScrollLeft() <= 0)return true
                }
                if (a.scrollmom) {
                    a.scrollmom.stop()
                }
        ...
        this.init = function () {
            ...
            if (!a.ispage || !c.cantouch && !c.isieold && !c.isie9mobile) {
                ...
                if (a.opt.boxzoom && !a.ispage && !c.isieold) {
                    ...
                    a.zoom = u(g);
                    a.zoom.css({cursor: "pointer", "z-index": a.zindex, backgroundImage: "url(" + l + "zoomico.png)", height: 18, width: 18, backgroundPosition: "0px 0px"});
                ...
                if (a.ispage) {
                    ...
                    if (a.ishwscroll) {
                        ...
                        if (a.viewport) {
                            a.body = a.viewport;
                            if (/fixed|relative|absolute/.test(a.viewport.css("position")) == false)a.css(a.viewport, {position: "relative"})
                        }
                        s.css({position: w});
                                        ...
                                        if (a.opt.touchbehavior) {
                                            if (t.onclick && !(t._onclick || false)) {
                                                ...
                                                t.onclick = function (e) {
                                                    var n = +(new Date) - a.scrollmom.lasttime;
                                                    if (a.hasmoving)return false;
        ...
        this.hideCursor = function (e) {
            ...
            if (a.hasmousefocus && a.opt.autohidemode == "leave")return;
            ...
            this.doScrollPos = function (e, t, n) {
                ...
                a.timer = setTimeout(function () {
                    ...
                    if (o > 0) {
                        ...
                        var f = n;
                        var l = r;
                        a.timerscroll = {bz: new BezierClass(f, a.newscrolly, o, 0, 0, .58, 1), bh: new BezierClass(l, a.newscrollx, o, 0, 0, .58, 1)};
